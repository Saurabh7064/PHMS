...
import com.team3.phms.security.services.UserDetailsImpl;
...
public class AuthController {
  ...
  public Response<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
    ...
    User user = new User(signUpRequest.getUsername(),  signUpRequest.getEmail(), encoder.encode(signUpRequest.getPassword()), signUpRequest.getAge(), signUpRequest.getGender(), signUpRequest.getWeight(), signUpRequest.getHeight());
